		     ...
		     <!--links --->
			  <div class="row " style="border-bottom:1px solid blue;padding:3px; margin:5px;">
				<div class="btn-set pull-right">
					<a href="<?php echo base_url(); ?>empform" class="btn  blue bold"><i class="fa fa-plus"></i>Add Employee</a>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			table = $('#table').DataTable({ 
				...
				"ajax": {
					"url": "<?php echo site_url('Employees/ajax_emplist')?>",
					"type": "POST",
