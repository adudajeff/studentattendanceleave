...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="<?php echo base_url(); ?>media/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">

    <!-- Waves Effect Css -->
    <link href="<?php echo base_url(); ?>media/plugins/node-waves/waves.css" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="<?php echo base_url(); ?>media/plugins/animate-css/animate.css" rel="stylesheet" />

    <!-- Sweetalert Css -->
    <link href="<?php echo base_url(); ?>media/plugins/sweetalert/sweetalert.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?php echo base_url(); ?>media/css/style.css" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo base_url(); ?>media/css/themes/all-themes.css" rel="stylesheet" />
</head>
...
<body class="theme-red">
    ...
    <!-- Jquery Core Js -->
    <script src="<?php echo base_url(); ?>media/plugins/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core Js -->
    <script src="<?php echo base_url(); ?>media/plugins/bootstrap/js/bootstrap.js"></script>

    <!-- Select Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/bootstrap-select/js/bootstrap-select.js"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/jquery-slimscroll/jquery.slimscroll.js"></script>

    <!-- Bootstrap Notify Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/bootstrap-notify/bootstrap-notify.js"></script>

    <!-- Waves Effect Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/node-waves/waves.js"></script>
    ...
    <script src="<?php echo base_url(); ?>media/js/pages/ui/dialogs.js"></script>
    ...
    <script src="<?php echo base_url(); ?>media/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- JQuery Steps Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/jquery-steps/jquery.steps.js"></script>
    <!-- SweetAlert Plugin Js -->
    <script src="<?php echo base_url(); ?>media/plugins/sweetalert/sweetalert.min.js"></script>
    ...
    <!-- Custom Js -->
    <script src="<?php echo base_url(); ?>media/js/admin.js"></script>
    <script src="<?php echo base_url(); ?>media/js/general.js"></script>
    <script src="<?php echo base_url(); ?>media/js/pages/forms/form-validation.js"></script>
