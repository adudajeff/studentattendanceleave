				...
				<div class="page-content">
					<div class="container">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<span>Edit Designation Screen</span>
							</li>
						</ul>
                                                ...
                                                <div class="portlet box blue">
                                                    <div class="portlet-title">
                                                        <div class="caption bold">
                                                            <i class="fa fa-gift"></i>Edit Designation Screen </div>
                                                        <div class="tools">
                                                    ...
                                                    <div class="portlet-body form" id="home">
                                                        <!-- BEGIN FORM-->
                                                        <form  enctype="multipart/form-data" class="horizontal-form" id="editdesignationform" name="editdesignationform" >
                                                        ...
                                                        <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                                               		...
                                                               		<div class="row">
																		...
																		<div class="col-md-12 ">
																			<div class="form-group">
																				...
																				<input type="text" id="designationcode" name="designationcode"  value="<?php echo $designationcode; ?>" class="form-control border-blue">  
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="designation" id="designation" value="<?php echo $designation; ?>" class="form-control border-blue"> 
																		</div>
                                                                    </div>
																	</div>
															</div>
