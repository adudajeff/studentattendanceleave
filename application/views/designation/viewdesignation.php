		     ...
		     <!--links --->
			  <div class="row " style="border-bottom:1px solid blue;padding:3px; margin:5px;">
				<div class="btn-set pull-right">
					<a href="<?php echo base_url(); ?>designation/newdesignation" class="btn  blue bold"><i class="fa fa-plus"></i>Add New Designation</a>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			table = $('#table').DataTable({ 
				...
				"ajax": {
					"url": "<?php echo site_url('Designation/ajax_designationlist')?>",
					"type": "POST",
