				<?php 
					...
					$sameeachyear="";
					 ...
					 {
						$holiday=$value->Description;
						$holidaydate=$value->Holiday;
						$sameeachyear=$value->SameEachYear;
					 }
				?>
						   ...
						   <div class="tab-pane " id="tab_1">
                                                <div class="portlet box blue">
                                                    ...
                                                    <div class="portlet-body form" id="home">
                                                        <!-- BEGIN FORM-->
                                                        <form  enctype="multipart/form-data" class="horizontal-form" id="editholidayform" name="editholidayform" >
														 
														 <!--links --->
														  <div class="form-actions top"  style="padding:4px;margin:5px;">
														 
														    <div class="btn-set pull-right">
																        <a href="<?php echo base_url(); ?>holiday" class="btn  blue bold"><i class="fa fa-eye"></i>&nbsp;View Holiday List</a>
                                                               		...
                                                               		<div class="row">
																		...
																		<div class="col-md-12 ">
																			<div class="form-group">
																				...
																				<input type="text" id="description" name="description" value="<?php echo $holiday; ?>" class="form-control border-blue">  
                                                                       ...
                                                                       <div class="form-group">
																			   <label >Same Each Year
																				...
																				<div class="input-group  date date-picker" data-date-format="dd-mm-yyyy" >
																					<input type="text" class="form-control border-blue" readonly id="holidaydate" name="holidaydate" value="<?php echo date('d-m-Y',strtotime($holidaydate)); ?>">
                                                                        ...
                                                                        <div class="form-group">
																			...
																			<span class="required"> * </span>
																			 ...
																			 <select name="sameeachyear" id="sameeachyear" class="form-control border-blue" required >
																				  <option value="<?php echo $sameeachyear; ?>" ><?php echo $sameeachyear; ?></option>
