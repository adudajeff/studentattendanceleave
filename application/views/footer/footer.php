 <!-- BEGIN QUICK SIDEBAR -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>About</h2>
                        <p>Apply and approve Leave at the comfort of your Office. </p>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs12 footer-block">
                        <h2>Contact us through adusoftjeff@gmail.com</h2>
                        <div class="subscribe-form">
                            <form action="javascript:;">
                                <div class="input-group">
                                    <input type="text" placeholder="adusoftjeff@gmail.com" class="form-control">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>Contacts</h2>
                        <address class="margin-bottom-40"> Phone: 0725811554
                            <br> Email:
                            <a href="mailto:info@metronic.com">adusoftjeff@gmail.com</a>
                        </address>
                    </div>
                </div>
            </div>
        ...
        <div class="page-footer">
            <div class="container"> 2014 &copy; JF.
                <a href="#" title="Pure JF Designs" target="_blank">Contact JF!</a>
            </div>
        </div>
...
<![endif]-->
        ...
        <!-- END THEME GLOBAL SCRIPTS upload -->
        ...
        <script src="<?php echo base_url(); ?>assets/form-validation.js" type="text/javascript"></script>
		<script src="<?php echo base_url(); ?>assets/general.js" type="text/javascript"></script>
